import type { CSSProperties, FunctionalComponent as VueFC,PropType } from "vue"
...
export const WithMdiIconProps = (_props: Partial<MdiIconProps>): VueFC<Partial<MdiIconProps>>  => {
  return (props) => {
